...
#            Updates Shapes attached to RoseCanvas objects, then draws them.
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            When you want the window to be manually closed. close_on_mouse_click closes the window when the user clicks the window.
#
